    ...
    >
      ...
      <div
        ...
        style={{
          ...
          height: "5%",
          background:
            "radial-gradient(ellipse, rgba(165,180,252,0.42) 0%, transparent 70%)",
          filter: "blur(5px)",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          borderRadius: "18%",
          background:
            "linear-gradient(135deg, rgba(255,255,255,0.80) 0%, rgba(224,231,255,0.64) 50%, rgba(199,210,254,0.52) 100%)",
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            background:
              "linear-gradient(135deg, rgba(255,255,255,0.52) 0%, transparent 50%)",
          }}
        />
        {/* Logo mark */}
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-1.5">
          <Image src={logo} alt="Ivorx Logo" width={80} height={80} />
          <span
            className="font-bold text-indigo-700 leading-none"
            style={{
              fontSize: "clamp(8px, 3.2%, 13px)",
              letterSpacing: "-0.2px",
            }}
          >
            ivorx
        ...
        <div
          ...
          style={{
            ...
            background:
              "linear-gradient(180deg, rgba(165,180,252,0.36) 0%, rgba(129,140,248,0.20) 100%)",
        ...
        <div
          ...
          style={{
            ...
            background:
              "linear-gradient(90deg, rgba(165,180,252,0.28) 0%, rgba(129,140,248,0.16) 100%)",
      ...
      <div
        ...
        style={{
          top: "8%",
          right: "0%",
          animation: "floatCube 5s ease-in-out infinite 0.8s",
        }}
      >
      ...
      <div
        ...
        style={{
          bottom: "22%",
          right: "2%",
          animation: "floatCube 4.2s ease-in-out infinite 1.4s",
        }}
      >
      ...
      <div
        ...
        style={{
          bottom: "28%",
          left: "2%",
          animation: "floatCube 3.8s ease-in-out infinite 0.4s",
        }}
      >
      ...
      <Sphere
        ...
        style={{
          bottom: "18%",
          left: "0%",
          animation: "floatCube 4s ease-in-out infinite 1.1s",
        }}
      />
    </div>
  );
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-center py-10 sm:py-12 lg:py-16">
          ...
          <div className="flex flex-col justify-center text-center lg:text-left order-2 lg:order-1">
            ...
            <FadeUp visible={visible} delay={80}>
              <h1
                className="font-bold text-slate-900 leading-[1.15] tracking-tight mb-5
            ...
            <FadeUp visible={visible} delay={160}>
              ...
              >
                We create innovative, reliable, and scalable IT solutions that
                help businesses grow, adapt, and lead in the modern digital
                landscape.
              </p>
            </FadeUp>
  ...
  return (
    ...
    >
      ...
      >
        Learn More
        <span
          className={`transition-transform duration-200 ${hover ? "translate-x-1" : "translate-x-0"}`}
        >
          <Icon.ArrowRight />
        </span>
      </button>
    ...
    <div ref={ref}>
      ...
      <div className={`text-center mb-10 sm:mb-12 ${fu(visible)}`}>
        ...
        <p className="text-sm sm:text-[15px] text-slate-500 max-w-lg mx-auto mt-4 leading-relaxed">
          End-to-end IT services designed to solve complex challenges and
...
const STEPS: StepItem[] = [
  ...
  },
  {
    num: "02",
    title: "Plan",
    desc: "We create a strategy tailored to your needs.",
    icon: <Icon.Lightbulb />,
  },
  {
    num: "03",
  ...
  },
  {
    num: "04",
    title: "Deliver",
    desc: "We deliver, support, and help you grow.",
    icon: <Icon.Rocket />,
  },
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 mb-8 sm:mb-10">
        <div className={`lg:col-span-5 ${fu(visible, 60)}`}>
          ...
          <p className="text-sm text-slate-500 leading-relaxed mt-4 max-w-md">
            We follow a proven process to deliver solutions that are efficient,
        ...
        <div className={`lg:col-span-7 ${fu(visible, 130)}`}>
          ...
          <div className="hidden md:flex items-start gap-0">
            {STEPS.map((step, i) => (
              <React.Fragment key={i}>
                <div
                  className={`flex flex-col items-center text-center flex-shrink-0 w-28 lg:w-32 ${fu(visible, 160 + i * 80)}`}
                >
                  {/* Icon circle */}
                  <div
                    className="w-12 h-12 lg:w-14 lg:h-14 rounded-2xl bg-white border border-blue-100/60
                    flex items-center justify-center text-blue-600
                    shadow-[0_6px_20px_rgba(99,102,241,0.10)] mb-4"
                  >
                    {step.icon}
                  </div>
                  <span className="text-[10px] font-bold text-blue-600/70 tracking-widest mb-1">
                    {step.num}
                  </span>
                  <p className="text-xs sm:text-[13px] font-bold text-slate-900 mb-1.5 leading-snug">
                    {step.title}
                  </p>
          ...
          <div className="grid grid-cols-2 gap-2 sm:gap-4 md:hidden">
            {STEPS.map((step, i) => (
              ...
              >
                <div
                  className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-blue-50/70 border border-blue-100/50
                  flex items-center justify-center text-blue-600
                  shadow-sm shadow-blue-100/30 mb-2 sm:mb-3"
                >
                  <div className="scale-75 sm:scale-100">{step.icon}</div>
                </div>
                <span className="text-[9px] sm:text-[10px] font-bold text-blue-500/80 tracking-widest mb-1">
                  {step.num}
                </span>
                <p className="text-[11px] sm:text-xs font-bold text-slate-900 mb-1 leading-snug">
                  {step.title}
                </p>
                <p className="text-[9px] sm:text-[11px] text-slate-400 leading-snug sm:leading-relaxed">
                  {step.desc}
                </p>
              </div>
            ))}
      ...
      */}
      <div className="grid grid-cols-2 lg:grid-cols-4">
        {STATS.map((s, i) => (
          ...
          >
            <div
              className="w-12 h-12 sm:w-12 sm:h-12 rounded-xl bg-blue-50/70 flex-shrink-0
            ...
            <div>
              <p className="text-xl sm:text-2xl font-extrabold tracking-tight text-slate-900 leading-none">
                <CountUp
                  from={0}
                  to={Number(s.value.replace(/[^0-9]/g, ""))}
                  separator=","
                  direction="up"
                  duration={2}
                  delay={0}
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          borderRadius: 18,
          background:
            "linear-gradient(140deg, rgba(224,231,255,0.80) 0%, rgba(199,210,254,0.62) 100%)",
      ...
      <div
        ...
        style={{
          ...
          borderRadius: 20,
          background:
            "linear-gradient(145deg, rgba(255,255,255,0.96) 0%, rgba(238,242,255,0.84) 100%)",
          border: "1px solid rgba(255,255,255,0.90)",
          boxShadow:
            "0 10px 36px rgba(99,102,241,0.14), 0 2px 6px rgba(0,0,0,0.04)",
      ...
      >
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-2">
          <Image src={logo} alt="Ivorx Logo" width={70} height={60} />
        ...
        [
          {
            ...
            sh: "0 3px 10px rgba(99,102,241,0.26)",
          },
          {
            w: 9,
            top: 55,
            ...
            sh: "0 2px 6px rgba(99,102,241,0.16)",
          },
          {
            w: 7,
            top: 28,
            ...
            sh: "0 2px 5px rgba(59,130,246,0.14)",
          },
        ] as const
      ).map((dot, i) => (
        <div
    ...
    >
      ...
      >
        ...
        <p className="text-slate-500 text-xs sm:text-sm leading-relaxed max-w-md mb-6 sm:mb-7">
          Let's discuss how we can help you achieve your business goals with the
          right technology.
        </p>
        <button
  ...
  return (
    <>
      ...
      <div className="w-full bg-white pt-5">
        ...
        {/* Main content */}
        <section
          className="bg-white w-full py-10 sm:py-12 lg:py-14"
          id="services"
        >
